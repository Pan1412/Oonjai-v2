...
//Comment
    //     this.router.get(
    //         "//:id/:idcomment", this.commentController.GetComment
    //     );
    //     this.router.post(
    //         "/:id/createcomment", this.commentController.CreateComment
    //     );

    //     this.router.delete(
    //         "/:id/:idcomment/delete", this.commentController.DeleteComment
    //     );
        
    //     this.router.patch(
    //         "/:id/:idcomment/update", this.commentController.EditComment
    //     );